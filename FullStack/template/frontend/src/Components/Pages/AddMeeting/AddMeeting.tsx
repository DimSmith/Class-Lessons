        ...
        <div className="AddMeeting BoxForm" >
			<h1>Add New Meeting</h1>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <br/><br/>
                    <input {...register("meeting.purpose", { required: true })} type="text" placeholder="Enter the Purpose" />
                    {errors.meeting?.purpose?.type==="required" && <><br/><span style={{color:"red"}}>Team ID is required.</span></>}
                    <br/><br/>
